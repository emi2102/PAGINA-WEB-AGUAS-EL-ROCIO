...
if (!empty($_SESSION['active'])) {
    ...
    if (!empty($_POST)) {
        ...
        if (empty($_POST['usuario']) || empty($_POST['clave'])) {
            ...
            $query = mysqli_query($conexion, "SELECT * FROM empleado WHERE usuario = '$user' AND clave = '$clave'");
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Bienvenido de nuevo VENDEDOR!</h1>
                                    ...
                                    <form class="user" method="POST" action="" autocomplete="off">
                                        ...
                                        <div class="form-group">
                                            <input type="password" class="form-control form-control-user" id="clave" name="clave" placeholder="contrasenia">
                                        </div>
